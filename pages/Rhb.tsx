  ...
  useEffect(() => {
    ...
    const handleResize = () => {
      if (window.innerWidth > 1047) {
        setSlidesToShow(2); // Large screens
      } else {
      ...
      <main className='md:px-16 px-5 mt-20'>
        <section>
          <div className='w-full flex justify-center items-center animate-slide-in-right'>
            <Image src="/c3.png" alt="" width={300} height={300} className='w-20 h-20 mt-5' />
          </div>
          <h3 className='text-2xl md:text-3xl mt-3 text-black text-center animate-slide-in-right'>RHB Get Your Hack On: ASEAN</h3>
          ...
          <div className='shadow-lg p-6 rounded-xl my-1 hover:scale-105 animate-slide-in'>
            ...
            <p className='text-base md:text-lg py-2 leading-5 md:leading-8 text-gray-800 text-justify' >
              <a className='pl-6'>• Mock Investment <br /></a>
              <a className='pl-6'>• Expenses Tracking <br /></a>
              <a className='pl-6'>• Gamification - Earn Voucher <br /></a>
            </p>
          </div>
        </section>
        ...
        <section>
          <div className='shadow-lg p-10 rounded-xl my-1'>
            ...
            <Slider {...settings}>
              <div>
                <Image src="/r1.jpg" alt="" className="mx-auto max-h-full mb-5 md:mb-0" width={200} height={200} />
              </div>
              <div>
                <Image src="/r2.jpg" alt="" className="mx-auto max-h-full mb-5 md:mb-0" width={200} height={200} />
              </div>
        ...
        <section>
          <div className='flex justify-center items-center'>
            <NextLink href="https://github.com/zerox555/rhb_Youth-master" target="_blank" rel="noopener noreferrer">
